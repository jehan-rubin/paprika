...
public class PaprikaContainer {
    ...
    public PaprikaClass addClass(SootClass sootClass) {
        if (classMap.containsKey(sootClass)) {
            return classMap.get(sootClass);
        }
        ...
        if (sootClass.hasSuperclass()) {
            ...
            paprikaClass.setParent(classMap.get(superclass));
            paprikaClass.setParentName(superclass.getName());
        }
        for (SootClass sInterface : sootClass.getInterfaces()) {
            if (!classMap.containsKey(sInterface)) {
                addClass(sInterface);
            }
            paprikaClass.implement(classMap.get(sInterface));
        }
